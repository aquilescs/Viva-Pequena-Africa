...
var style_ReligioesdematrizeinflunciaAfricana_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
		...
		var color = `rgba(225, 133, 129, 0.75)`;
		return [
			new ol.style.Style({
				image: new ol.style.Circle({
					radius: radius + 4,
					fill: new ol.style.Fill({
						color: `rgba(225, 133, 129, 0.3)`
					})
				})
			}),
			new ol.style.Style({
