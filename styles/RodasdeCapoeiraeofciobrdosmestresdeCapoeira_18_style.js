...
var style_RodasdeCapoeiraeofciobrdosmestresdeCapoeira_18 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "13.0px \'Le Monde Journal Std Demi\', sans-serif";
    ...
    if (size == 1) { // If cluster has one feature
		...
		var color = `rgba(197, 98, 101, 0.75)`;
		return [
			new ol.style.Style({
				image: new ol.style.Circle({
					radius: radius + 4,
					fill: new ol.style.Fill({
						color: `rgba(197, 98, 101, 0.3)`
					})
				})
			}),
			new ol.style.Style({
