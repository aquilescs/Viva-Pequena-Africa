...
var style_MatrizesdoSambadoRiodeJaneiro_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
		...
		var color = `rgba(251, 154, 153, 0.75)`;
		return [
			new ol.style.Style({
				image: new ol.style.Circle({
					radius: radius + 4,
					fill: new ol.style.Fill({
						color: `rgba(251, 154, 153, 0.3)`
					})
				})
			}),
			new ol.style.Style({
